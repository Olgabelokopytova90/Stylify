...
import { getOutfitSimple } from "./api/"; // API-функция загрузки вещей (по фильтрам)
import type { Filters, Item, Slot, SelectedBySlot } from "./types"; // типы для строгой типизации
import Layout from "./components/Layout"; // общий каркас страницы
import Controls from "./components/Controls"; // панель фильтров и кнопок
import OutfitGrid from "./components/OutfitGrid"; // сетка карточек одежды
import OutfitPreview from "./components/OutfitPreview"; // «примерочная» с аватаром и слоями
